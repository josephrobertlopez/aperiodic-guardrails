...
We extracted syntactic monoids from a corpus of 140 regex patterns drawn from eleven
...
\begin{enumerate}
  ...
  \item \textbf{140-pattern regex corpus analysis} (\cref{sec:corpus}):
    confirms $97.9\%$ aperiodicity across eleven open-source guardrail tools with
...
We collected 140 regex patterns from eleven open-source guardrail tools (LLM Guard,
...
\paragraph{Results.}
Of the 140 patterns, 137 ($97.9\%$) have aperiodic syntactic monoids.
...
\paragraph{Evidence.}
$97.9\%$ of the 140-pattern corpus is aperiodic.
The three non-aperiodic patterns are numeric range checks, not semantic filters.
Among the 137 semantic filter patterns, the aperiodicity rate is $100\%$.
...
The corpus of 140 patterns from 11 tools is representative but not exhaustive.
