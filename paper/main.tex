...
Artifact: \texttt{results/non\_llm\_defense\_bypass.json}
...
(\texttt{src/aperiodic\_guardrails/benchmark/runner.py}) at $N = 50$,
...
$\{z_0\}{\to}\{z_1,z_2\}{\to}\{z_3,z_2\}{\to}\{z_3,z_4,z_5\}{\to}\{z_6,z_5\}{\to}\{z_6,z_7\}{\to}\{z_*\}$.
...
rates are released in the artifact \texttt{results/transformer\_tc0\_validation.json}.
...
archived in \texttt{results/comprehensive\_empirical\_validation.json}
...
\texttt{results/comprehensive\_empirical\_validation.json}; the V1 / V3
adaptive-adversary rows (100\% evasion of both regex and neural) are
backed by \texttt{results/class\_c\_adaptive\_adversary.json}
