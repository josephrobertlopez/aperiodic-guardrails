...
The conclusion is that neural guardrails address the $\mathrm{AC}^0$ blind
spot at a price---both economic and security-theoretic---and the defense
stack remains incomplete: the illustrative Fano-type lower bound of
Proposition~\ref{prop:fano} still applies (under its uniformity assumption)
regardless of the guardrail's computational class, and adversarial
robustness of neural filters is a separate unsolved problem.
