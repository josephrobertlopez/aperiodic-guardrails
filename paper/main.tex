...
algebraic blindness arising from syntactic monoid aperiodicity (unconditional);
an illustrative information-theoretic lower bound (Fano-type, under a
uniformity assumption);
NP-hardness of instantiation verification;
and structural transfer via functorial homomorphism combined with syntactic
...
(Proposition~\ref{thm:indistinguish}) require only that the LLM-visible
