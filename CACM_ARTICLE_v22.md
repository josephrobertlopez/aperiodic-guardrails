...
The companion technical preprint (current version v2: https://doi.org/10.5281/zenodo.20173462; concept DOI for all versions: https://doi.org/10.5281/zenodo.20103484) contains the formal apparatus: full proofs of the substring-aperiodicity theorem and the modular-counting bypass, the Krohn-Rhodes audit construction, the composition laws with full case analysis, and the homomorphic-reasoning attack vectors. The released artifact bundle (https://doi.org/10.5281/zenodo.20103493) contains the 142-pattern corpus, the monoid extractor, all bypass harnesses, and the JSON pilots cited inline.
